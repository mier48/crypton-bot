...
DEFAULT_CHECK_PRICE_INTERVAL = "3m" # 3-minute price interval for scalping rápido
DEFAULT_HISTORICAL_RANGE_HOURS = 5  # 4-hour histórico ajustado para trading rápido
