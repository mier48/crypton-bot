...
DEFAULT_CHECK_PRICE_INTERVAL = "15m" # 15-minute price interval for scalping rápido
DEFAULT_HISTORICAL_RANGE_HOURS = 24 * 4  # 4-hour histórico ajustado para trading rápido
